  ...
  <body>
    <div class="header">
      <div class="navbar">
        ...
        <ul>
          ...
          <li><a href="proefrijden.php">contact</a></li>
          <div class="dropdown">
            <li><a href="#">Inloggen</a></li>
            <div class="dropdown-content">

              <a href="Login-registration-System-PHP-and-MYSQL-master/index.php">Instructuur</a>
            </div>
          </div>
        </ul>
      </div>
    ...
    <div class="content" id="Tarieven" id="Over ons">
      ...
      <div class="reclame">
        ...
        <a href="Proefrijden.php">
          <button
            class="reclamebtn"
            onclick="window.location.href = 'proefrijden.php' a="Proefrijden.php"
          >
            Schrijf je nu in!
          </button></a
        >
